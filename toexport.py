...
app.setIcon(resource_path('img/debug.gif'))
...
if app:
    ...
    app.setButtonImage("vscode", resource_path('img/vscode.gif'))
    app.setButtonBg("vscode", "#192227")
    app.setButtonRelief("vscode", "flat")

    app.setButtonImage("sublime", resource_path("img/sublime.gif"))
    ...
    app.setSticky("ew")
    app.addImage("logo", resource_path("img/logo.gif"), row=0, column=1, colspan=2, rowspan=1)
    app.setSticky("e")
